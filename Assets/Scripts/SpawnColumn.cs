...
public class SpawnColumn : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        despawnPosition = new Vector3(transform.position.x, transform.position.y, despawnPosition.z);//TODO: esto es pa no tener que cambiar nada, lo suyo seria pillar la posicion
                                                                                                     //un transform a traves de un SerializedField
    }
